...
const PlantVisualization = {
  ...
  init() {
    ...
    if (typeof THREE === 'undefined') {
      console.error('THREE.js library is not loaded. 3D visualization disabled.');
    ...
    if (this.container) {
      this.container.innerHTML = `
        <div class="d-flex flex-column align-items-center justify-content-center h-100 p-4 text-center">
          ...
          <h5 class="mt-3">3D Visualization Unavailable</h5>
          <p class="text-muted">Could not initialize the 3D visualization. Make sure your browser supports WebGL.</p>
        </div>
      `;
    }
  },
